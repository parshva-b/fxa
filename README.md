...
Note this starts up all required services, including Redis, MySQL, and Memcached. You should not be running them yourself, or occupying any of the [server ports](https://github.com/mozilla/fxa/blob/master/mysql_servers.json). Doing so may result in errors.
